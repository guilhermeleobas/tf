...
int *calculate_bm_table(char *pattern, int pattern_length)
{
  int i;
...
\********************************************************************/
int boyer_moore(char *y, int n, char *x, int m, int *bmBc)
{
  int j, k, shift;
...
struct rtentry *find_destination(char *packet, int packet_size)
{
...
\********************************************************************/
PatternNode *NewPatternNode(int chainno, nodetype type, char *pattern,
                            int pattern_length, int search_depth)
{
...
StrTreeNode *NewStrTreeNode(int chainno, char *pattern, int pattern_length)
{
  ...
  returnval->bm_table =
      calculate_bm_table(returnval->common_pattern, pattern_length);
...
\********************************************************************/
char *find_lcs(char *largepattern, int largepatternsize, char *smallpattern,
               int smallpatternsize, int *lcssize)
{
...
void insert_rule(char *pattern, int pattern_length, int depth)
{
