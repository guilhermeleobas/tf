...
bodyptr body_alloc(int p, real p0, real p1, real p2, real v0, real v1, real v2,
                   real a0, real a1, real a2, real mass, bodyptr ob);
bodyptr ubody_alloc(int p);
cellptr cell_alloc(int p);
...
/*
 * SUBINDEX: determine which subcell to select.  Rolled intcoord & subindex
 * together.
 */
...
void printtree(nodeptr n) { ptree(n, 0); }
void ptree(nodeptr n, int level)
{
  nodeptr r;
