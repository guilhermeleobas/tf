...
hypre_CSRMatrix *hypre_CSRMatrixCreate(int num_rows, int num_cols,
                                       int num_nonzeros)
{
 ...
 * Creates and returns a matrix whose elements are the union of those of A and
 *B.
...
hypre_CSRMatrix *hypre_CSRMatrixUnion(hypre_CSRMatrix *A, hypre_CSRMatrix *B,
                                      int *col_map_offd_A, int *col_map_offd_B,
                                      int **col_map_offd_C)
{
  int num_rows = hypre_CSRMatrixNumRows(A);
