...
void init(double slipRate[MS_XTAL_NSLIP_MAX],
          double dSlipRate[MS_XTAL_NSLIP_MAX], double tau[MS_XTAL_NSLIP_MAX],
          double tauc[MS_XTAL_NSLIP_MAX], double rhs[MS_XTAL_NSLIP_MAX],
...
int main()
{
  ...
  returnVal =
      SPEdriver(slipRate, dSlipRate, tau, tauc, rhs, dtcdgd, dtdg, matrix);
