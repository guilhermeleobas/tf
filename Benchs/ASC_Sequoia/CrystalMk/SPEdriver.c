...
void Crystal_div(int nSlip, double deltaTime,
                 double slipRate[MS_XTAL_NSLIP_MAX],
                 double dSlipRate[MS_XTAL_NSLIP_MAX],
                 double tau[MS_XTAL_NSLIP_MAX], double tauc[MS_XTAL_NSLIP_MAX],
...
double Crystal_pow(int nSlip, double slipRate[MS_XTAL_NSLIP_MAX]);

void Crystal_Cholesky(int nSlip, double a[MS_XTAL_NSLIP_MAX][MS_XTAL_NSLIP_MAX],
                      double r[MS_XTAL_NSLIP_MAX], double g[MS_XTAL_NSLIP_MAX]);
