...
int main(int argc, char *argv[])
{
  ...
  if (argc == 0)
  ...
  else
    {
      ...
      while (argc--)
        { /* one or more filenames on command line -- put
          the valid filenames in a array of strings */
          /*
            if ((filetype = check_file(*argv)) != ISASCIIFILE) {
              if(filetype == NOSUCHFILE) fprintf(stderr,"%s: %s: no such file or
         directory\n",Progname,*argv);
              argv++;
      */
      ...
      while ((num_read = read(Text, buffer + Maxline, BlockSize)) > 0)
        {
          ...
          if (FIRST_LOOP)
            { /* if first time in the loop add a newline */
              buffer[i - 1] = '\n'; /* in front the  text.  */
              i--;
              FIRST_LOOP = 0;
            }
      ...
      while (i < end)
        {
          ...
          if (c != Newline)
              ...
              if (CMask != 0)
                {
                  ...
                  r1 = Init1 & r3;
                  r0 = r2 | A[0]; /* A[0] | B[0] */
                  A[1] = ((Next[r3 >> hh] | Next1[r3 & LL]) & CMask) |
                         ((r2 | Next[r0 >> hh] | Next1[r0 & LL]) & r_NO_ERR) | r1;
                  if (D == 1)
                    {
                      goto Nextchar;
                    }
                  ...
                  A[2] = ((Next[r2 >> hh] | Next1[r2 & LL]) & CMask) |
                         ((r3 | Next[r0 >> hh] | Next1[r0 & LL]) & r_NO_ERR) | r1;
                  if (D == 2)
                    {
                      goto Nextchar;
                    }
                  ...
                  r1 = Init1 & r3;
                  r0 = r2 | A[2];
                  A[3] = ((Next[r3 >> hh] | Next1[r3 & LL]) & CMask) |
                         ((r2 | Next[r0 >> hh] | Next1[r0 & LL]) & r_NO_ERR) | r1;
                  if (D == 3)
                    {
                      goto Nextchar;
                  ...
                  r1 = Init1 & r2;
                  r0 = r3 | A[3];
                  A[4] = ((Next[r2 >> hh] | Next1[r2 & LL]) & CMask) |
                         ((r3 | Next[r0 >> hh] | Next1[r0 & LL]) & r_NO_ERR) | r1;
                  if (D == 4)
                    {
                      goto Nextchar;
          ...
          else
            {
              ...
              if (TAIL)
                {
                  A[D] = (Next[A[D] >> hh] | Next1[A[D] & LL]) | A[D];
                }
              /* epsilon move */
              if ((A[D] & 1) ^ INVERSE)
                {
              ...
              for (k = 1; k <= D; k++)
                {
                  ...
                  r1 = Init1 & r3;
                  r2 = A[k - 1] | B[k - 1];
                  A[k] = ((Next[r3 >> hh] | Next1[r3 & LL]) & CMask) |
                         ((B[k - 1] | Next[r2 >> hh] | Next1[r2 & LL]) & r_NO_ERR) | r1;
                }
            }
        Nextchar:
          i = i + 1;
          ...
          if (c != Newline)
              ...
              if (CMask != 0)
                {
                  ...
                  r1 = Init1 & r3;
                  r0 = B[0] | r2;
                  B[1] = ((Next[r3 >> hh] | Next1[r3 & LL]) & CMask) |
                         ((r2 | Next[r0 >> hh] | Next1[r0 & LL]) & r_NO_ERR) | r1;
                  if (D == 1)
                    {
                      goto Nextchar1;
                  ...
                  r1 = Init1 & r2;
                  r0 = B[1] | r3;
                  B[2] = ((Next[r2 >> hh] | Next1[r2 & LL]) & CMask) |
                         ((r3 | Next[r0 >> hh] | Next1[r0 & LL]) & r_NO_ERR) | r1;
                  if (D == 2)
                    {
                      goto Nextchar1;
                  ...
                  r1 = Init1 & r3;
                  r0 = B[2] | r2;
                  B[3] = ((Next[r3 >> hh] | Next1[r3 & LL]) & CMask) |
                         ((r2 | Next[r0 >> hh] | Next1[r0 & LL]) & r_NO_ERR) | r1;
                  if (D == 3)
                    {
                      goto Nextchar1;
                  ...
                  r1 = Init1 & r2;
                  r0 = B[3] | r3;
                  B[4] = ((Next[r2 >> hh] | Next1[r2 & LL]) & CMask) |
                         ((r3 | Next[r0 >> hh] | Next1[r0 & LL]) & r_NO_ERR) | r1;
                  if (D == 4)
                    {
                      goto Nextchar1;
          ...
          else
            {
              ...
              if (TAIL)
                {
                  B[D] = (Next[B[D] >> hh] | Next1[B[D] & LL]) | B[D];
                }
              /* epsilon move */
              if ((B[D] & 1) ^ INVERSE)
                {
              ...
              for (k = 1; k <= D; k++)
                {
                  ...
                  r1 = Init1 & r3;
                  r2 = A[k - 1] | B[k - 1];
                  B[k] = ((Next[r3 >> hh] | Next1[r3 & LL]) & CMask) |
                         ((A[k - 1] | Next[r2 >> hh] | Next1[r2 & LL]) & r_NO_ERR) | r1;
                }
            }
        Nextchar1:
          i = i + 1;
          ...
          if (c != Newline)
            {
              ...
              r1 = Init1 & A[1];
              B[1] =
                  (Next[A[1]] & CMask) | ((A[0] | Next[A[0] | B[0]]) & r_NO_ERR) | r1;
              if (D == 1)
                {
                  goto Nextchar1;
                }
              r1 = Init1 & A[2];
              B[2] =
                  (Next[A[2]] & CMask) | ((A[1] | Next[A[1] | B[1]]) & r_NO_ERR) | r1;
              if (D == 2)
                {
                  goto Nextchar1;
                }
              r1 = Init1 & A[3];
              B[3] =
                  (Next[A[3]] & CMask) | ((A[2] | Next[A[2] | B[2]]) & r_NO_ERR) | r1;
              if (D == 3)
                {
                  goto Nextchar1;
                }
              r1 = Init1 & A[4];
              B[4] =
                  (Next[A[4]] & CMask) | ((A[3] | Next[A[3] | B[3]]) & r_NO_ERR) | r1;
              goto Nextchar1;
            } /* if(NOT Newline) */
          else
            {
...
void usage(void)
{
  fprintf(
      stderr,
      "usage: %s [-#cdehiklnpstvwxBDGIS] [-f patternfile] pattern [files]\n",
      Progname);
  printf("\n");
