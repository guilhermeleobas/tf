      ...
      switch (Pattern[i])
        {
            ...
            while (Pattern[i] != RRANGE && i < M)
              {
                if (Pattern[i] == HYPHEN)
                  {
                    position[j].class1[k - 1] = Pattern[i + 1];
                    i = i + 2;
                  }
                else
                  {
          ...
          case ANDPAT:
            ...
            break;
          /*
          case ' '    : if (Pattern[i-1] == ORPAT || Pattern[i-1] == ANDPAT)
         break;
