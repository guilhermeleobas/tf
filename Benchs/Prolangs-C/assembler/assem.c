  ...
  else
  {
    ...
    else
    {
      ...
      if (!DEBUG_FLAG_1)
      {
        char *TEMP;
        TEMP =
            (char *)malloc((unsigned int)(4 + strlen(TEMP_OUTPUT_FILE_NAME)));
      ...
      {
        char *TEMP;
        TEMP = (char *)malloc((unsigned int)(4 + strlen(OBJECT_FILE)));
