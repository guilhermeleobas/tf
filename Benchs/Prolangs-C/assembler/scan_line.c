...
int IS_ALPHA_NUM(CH) char CH; /* Character in question. */
{
  CH = UPPER(CH);
...
int IS_BLANK_OR_TAB(CH) char CH; /* Character in question. */
{
...
int eoln(CH) char CH; /* Character in question.                          */
{
  return (CH == '\0');
}
...
void SCAN_LINE(LOCATION_COUNTER, INPUT_LINE, LABEL, EXTENDED, OPERATOR, REST,
               PASS, STREAM, INPUT_STREAM) int LOCATION_COUNTER; /* SIC/XE
                                                                    location
                                                                    counter at
                                                                    start of
                                                                    line*/
