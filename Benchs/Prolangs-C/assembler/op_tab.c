...
struct OP_ENTRY OP_TABLE[] = {
    ...
    {"DIV", THREE_FOUR, "24", MEM, NULL},
    {"DIVR", TWO, "9C", REG_REG, NULL},
    ...
    {"HIO", ONE, "F4", NONE, NULL},
    {"J", THREE_FOUR, "3C", MEM, NULL},
    {"JEQ", THREE_FOUR, "30", MEM, NULL},
    {"JGT", THREE_FOUR, "34", MEM, NULL},
    {"JLT", THREE_FOUR, "38", MEM, NULL},
    {"JSUB", THREE_FOUR, "48", MEM, NULL},
    {"LDA", THREE_FOUR, "00", MEM, NULL},
    {"LDB", THREE_FOUR, "68", MEM, NULL},
    {"LDCH", THREE_FOUR, "50", MEM, NULL},
    {"LDL", THREE_FOUR, "08", MEM, NULL},
    {"LDS", THREE_FOUR, "6C", MEM, NULL},
    {"LDT", THREE_FOUR, "74", MEM, NULL},
    {"LDX", THREE_FOUR, "04", MEM, NULL},
    {"LPS", THREE_FOUR, "D0", MEM, NULL},
    {"MUL", THREE_FOUR, "20", MEM, NULL},
    {"MULR", TWO, "98", REG_REG, NULL},
    {"OR", THREE_FOUR, "44", MEM, NULL},
    {"RD", THREE_FOUR, "D8", MEM, NULL},
    {"RESB", PSEUDO, "  ", PSEUDO_LOC, PSEUDO_RESB0},
    {"RESW", PSEUDO, "  ", PSEUDO_LOC, PSEUDO_RESW0},
    {"RMO", TWO, "AC", REG_REG, NULL},
    {"RSUB", THREE_FOUR, "4C", NONE, NULL},
    {"SHIFTL", TWO, "A4", REG_NUM, NULL},
    {"SHIFTR", TWO, "A8", REG_NUM, NULL},
    {"SIO", ONE, "F0", NONE, NULL},
    {"SSK", THREE_FOUR, "EC", MEM, NULL},
    {"STA", THREE_FOUR, "0C", MEM, NULL},
    {"START", PSEUDO, "  ", PSEUDO_ADDR, PSEUDO_START0},
    {"STB", THREE_FOUR, "78", MEM, NULL},
    {"STCH", THREE_FOUR, "54", MEM, NULL},
    {"STI", THREE_FOUR, "D4", MEM, NULL},
    {"STL", THREE_FOUR, "14", MEM, NULL},
    {"STS", THREE_FOUR, "7C", MEM, NULL},
    {"STSW", THREE_FOUR, "E8", MEM, NULL},
    {"STT", THREE_FOUR, "84", MEM, NULL},
    {"STX", THREE_FOUR, "10", MEM, NULL},
    {"SUB", THREE_FOUR, "1C", MEM, NULL},
    {"SUBR", TWO, "94", REG_REG, NULL},
    {"SVC", TWO, "B0", NUM, NULL},
    {"TD", THREE_FOUR, "E0", MEM, NULL},
    {"TIO", ONE, "F8", NONE, NULL},
    {"TIX", THREE_FOUR, "2C", MEM, NULL},
    {"TIXR", TWO, "B8", REG, NULL},
    {"WD", THREE_FOUR, "DC", MEM, NULL},
