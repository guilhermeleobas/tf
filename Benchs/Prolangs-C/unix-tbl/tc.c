...
void choochar(void)
{
  ...
  for (s = "\002\003\005\006\007!%&#/"
           "?,:;<=>@`^~_{}+-*ABCDEFGHIJKMNOPQRSTUVWXYZabcdefgjkoqrstwxyz";
       *s; s++)
  {
    if (had[*s] == 0)
    {
  ...
  for (s = "\002\003\005\006\007:_~^`@;,<=>#%&!/"
           "?{}+-*ABCDEFGHIJKMNOPQRSTUVWXZabcdefgjkoqrstuwxyz";
       *s; s++)
  {
    if (had[*s] == 0)
    {
...
int point(int s) { return (s >= 128 || s < 0); }
