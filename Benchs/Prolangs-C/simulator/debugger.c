...
struct COMMAND_TYPE
{
  ...
  int FUNCTION;
    ...
    {"S", "STEP", STEP0},     {"B", "BREAK", SET_BP0},
    {"L", "LOC", EXAMINE0},   {"RB", "RESET", RESET_BP0},
    {"R", "RUN", RUN_IT0},    {"H", "HELP", HELP0},
    {"M", "MODE", MODE0},     {"P", "PROCEED", PROCEED0},
    {"T", "TRACE", TRACE_P0}, {"U", "UNTRACE", UNTRACE0},
    {"Q", "QUIT", QUIT0}};
