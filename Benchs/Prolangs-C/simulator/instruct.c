  ...
  if (VALUE == 0)
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("Attempted division by zero.\n");
        }
    }
  else
    {
  ...
  if ((VALUE < 0) || ((VALUE >= MEM_SIZE_1) && VALUE != RETURN_TO_OS_1))
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("J m, m is an illegal address.\n");
        }
    }
  else
    {
  ...
  if (CC() != EQUAL_1)
    {
      if (PRINT_EFFECT)
        {
          (void)printf("No action taken.\n");
        }
    }
  else if ((VALUE < 0) || ((VALUE >= MEM_SIZE_1) && VALUE != RETURN_TO_OS_1))
    {
      SIGNAL_INTERUPT(2, 02);
      if (PRINT_EFFECT)
        {
          (void)printf("JEQ m, m is an illegal address.\n");
        }
    }
  else
    {
...
void JGT_P(BOOLEAN PRINT_EFFECT)
{
  ...
  if (CC() != GREATER_THAN_1)
  ...
  else if ((VALUE < 0) || ((VALUE >= MEM_SIZE_1) && VALUE != RETURN_TO_OS_1))
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("JGT m, m is an illegal address.\n");
        }
    }
  else
    {
...
void JLT_P(BOOLEAN PRINT_EFFECT)
{
  ...
  if (CC() != LESS_THAN_1)
  ...
  else if ((VALUE < 0) || ((VALUE >= MEM_SIZE_1) && VALUE != RETURN_TO_OS_1))
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("JLT m, m is an illegal address.\n");
        }
    }
  else
    {
  ...
  if ((VALUE < 0) || (VALUE >= MEM_SIZE_1))
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("JSUB m, m is an illegal address.\n");
        }
    }
  else
    {
  ...
  if (ADDRESS + 2 >= MEM_SIZE_1)
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("STA m, m is an illegal address.\n");
        }
    }
  else
    {
      ...
      MEMORY[ADDRESS + 1] =
          (A_0 - INT(MEMORY[ADDRESS]) * (MAX_BYTE_VAL_0 * MAX_BYTE_VAL_0)) /
          MAX_BYTE_VAL_0;
  ...
  if (ADDRESS + 2 >= MEM_SIZE_1)
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("STB m, m is an illegal address.\n");
        }
    }
  else
    {
      ...
      MEMORY[ADDRESS + 1] =
          (B_0 - INT(MEMORY[ADDRESS]) * (MAX_BYTE_VAL_0 * MAX_BYTE_VAL_0)) /
          MAX_BYTE_VAL_0;
  ...
  if (!SUPERVISOR_MODE())
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("STI is a privileged instruction.\n");
        }
    }
  else
    {
      ...
      if (ADDRESS + 2 >= MEM_SIZE_1)
        {
          ...
          if (PRINT_EFFECT)
            {
              (void)printf("STI m, m is an illegal address.\n");
            }
        }
      else
        {
  ...
  if (ADDRESS + 2 >= MEM_SIZE_1)
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("STL m, m is an illegal address.\n");
        }
    }
  else
    {
      ...
      MEMORY[ADDRESS + 1] =
          (L_0 - INT(MEMORY[ADDRESS]) * (MAX_BYTE_VAL_0 * MAX_BYTE_VAL_0)) /
          MAX_BYTE_VAL_0;
  ...
  if (ADDRESS + 2 >= MEM_SIZE_1)
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("STS m, m is an illegal address.\n");
        }
    }
  else
    {
      ...
      MEMORY[ADDRESS + 1] =
          (S_0 - INT(MEMORY[ADDRESS]) * (MAX_BYTE_VAL_0 * MAX_BYTE_VAL_0)) /
          MAX_BYTE_VAL_0;
  ...
  if (!SUPERVISOR_MODE())
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("STSW is a privileged instruction.\n");
        }
    }
  else
    {
      ...
      if (ADDRESS + 2 >= MEM_SIZE_1)
        {
          ...
          if (PRINT_EFFECT)
            {
              (void)printf("STSW m, m is an illegal address.\n");
            }
        }
      else
        {
          ...
          MEMORY[ADDRESS + 1] =
              (SW_0 - INT(MEMORY[ADDRESS]) * (MAX_BYTE_VAL_0 * MAX_BYTE_VAL_0)) /
              MAX_BYTE_VAL_0;
  ...
  if (ADDRESS + 2 >= MEM_SIZE_1)
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("STT m, m is an illegal address.\n");
        }
    }
  else
    {
      ...
      MEMORY[ADDRESS + 1] =
          (T_0 - INT(MEMORY[ADDRESS]) * (MAX_BYTE_VAL_0 * MAX_BYTE_VAL_0)) /
          MAX_BYTE_VAL_0;
  ...
  if (ADDRESS + 2 >= MEM_SIZE_1)
    {
      ...
      if (PRINT_EFFECT)
        {
          (void)printf("STX m, m is an illegal address.\n");
        }
    }
  else
    {
      ...
      MEMORY[ADDRESS + 1] =
          (X_0 - INT(MEMORY[ADDRESS]) * (MAX_BYTE_VAL_0 * MAX_BYTE_VAL_0)) /
          MAX_BYTE_VAL_0;
