  ...
  for (; plptr != (PLISTPTR)NULL; plptr = plptr->pnext)
    {
      ...
      yNodules[numberCells + 1].inList->eindex = (int *)malloc(2 * sizeof(int));
              ...
              for (; plptr != (PLISTPTR)NULL; plptr = plptr->pnext)
                {
                  ...
                  yNodules[cell].inList->eindex = (int *)malloc(2 * sizeof(int));
              ...
              for (; plptr != (PLISTPTR)NULL; plptr = plptr->pnext)
                {
                  ...
                  yNodules[cell].outList->eindex = (int *)malloc(2 * sizeof(int));
          ...
          for (; ofptr != (FLAREPTR)NULL; ofptr = ofptr->next)
            {
              ...
              yNodeArray[inode]->length = edgeList[oedge].loc - edgeList[iedge].loc;
            }
        }
    }
  for (cell = 0; cell <= numberCells + 1; cell++)
      ...
      for (; ofptr != (FLAREPTR)NULL; ofptr = ofptr->next)
        {
          ...
          yNodeArray[inode]->node = onode;
          yNodeArray[inode]->channels =
              (int *)malloc((1 + ofptr->eindex[0]) * sizeof(int));
