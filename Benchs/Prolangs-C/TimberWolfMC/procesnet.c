  ...
  for (;;)
    {
      ...
      netRoutes[net].alternate[numberRoutes]->pinList =
          (int *)malloc((1 + pincount) * sizeof(int));
              ...
              if (lastcptr == (CHANBOXPTR)NULL)
                {
                  ...
                  lastcptr = netRoutes[net].alternate[numberRoutes]->chanList;
                }
              else
                {
                  lastcptr = lastcptr->next = (CHANBOXPTR)malloc(sizeof(CHANBOX));
                }
              lastcptr->from = fnode;
              lastcptr->to = tnode;
          ...
          for (j = i + 1; j <= netSegArray[0][0]; j++)
            {
              ...
              else if (netSegArray[i][1] == netSegArray[j][netSegArray[j][0]])
                {
                  joinSeg(i, -1, j, 1);
                  flag = 1;
                  break;
          ...
          for (j = i + 1; j <= netSegArray[0][0]; j++)
            {
              ...
              else if (netSegArray[i][netSegArray[i][0]] == netSegArray[j][1])
                {
                  joinSeg(i, 1, j, -1);
                  i--;
                  break;
  ...
  if (aend < 0)
  ...
  else
    {
      if (bend < 0)
        ...
        {
          for (i = netSegArray[a][0] + 1, j = netSegArray[b][0] - 1; j >= 1;
               i++, j--)
            {
              netSegArray[a][i] = netSegArray[b][j];
            }
