...
void reduceg(void)
{
  ...
  for (i = 1; i <= numXnodes; i++)
  {
    for (ptr = xNodeArray[i]; ptr != (WCPTR)NULL; ptr = ptr->next)
    {
      ...
      if (WCcount % 100 == 0)
      {
        WCarray = (WCPTR *)realloc(WCarray, (WCcount + 100) * sizeof(WCPTR));
      }
      length = 0;
      for (c = 1; c <= count; c++)
      {
  ...
  for (;;)
  {
    ...
    do
    {
      ...
      for (c = c1; c <= c2; c++)
      {
        ...
        {
          eArray[ptr->channels[c]].rtside = eArray[ptr->channels[c2]].rtside;
          eArray[ptr->channels[c]].lbside = eArray[ptr->channels[c1]].lbside;
        }
        if (c == c1)
        {
          if (vertical == 1)
    ...
    for (i = 1; i <= numXnodes; i++)
    {
      for (ptr = xNodeArray[i]; ptr != (WCPTR)NULL; ptr = ptr->next)
      {
        ...
        for (c = 1; c <= count; c++)
        {
          ...
          if (rectArray[index2].nedges == 1 || rectArray[index1].nedges == 1)
          {
            eArray[ptr->channels[c]].notActive = 1;
            rectArray[index2].nedges--;
            rectArray[index1].nedges--;
            ...
            for (k = 1;; k++)
            {
              if (c + k <= count)
              {
                if (eArray[ptr->channels[c + k]].notActive == 0)
                {
                  flag = 1;
          ...
          for (c = 2; c <= count; c++)
          {
            if (eArray[ptr->channels[c]].notActive == 0)
            {
              ...
              if (rectArray[i2].yc < ymax)
              {
                ...
                if (rectArray[j].t < end && rectArray[j].yreset == 0)
                {
              ...
              if (rectArray[i1].yc > ymin)
              {
                ...
                if (start < rectArray[j].b && rectArray[j].yreset == 0)
                {
        ...
        if (eArray[ptr->channels[1]].notActive == 1)
        {
          ...
          for (c = 2; c <= count; c++)
          {
            if (eArray[ptr->channels[c]].notActive == 0)
            {
              ...
              {
                j = eArray[ptr->channels[1]].index2;
                if (rectArray[j].r < end && rectArray[j].xreset == 0)
                {
              ...
              {
                j = eArray[ptr->channels[1]].index1;
                if (start < rectArray[j].l && rectArray[j].xreset == 0)
                {
