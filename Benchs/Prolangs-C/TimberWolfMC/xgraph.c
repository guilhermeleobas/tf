  ...
  for (; plptr != (PLISTPTR)NULL; plptr = plptr->pnext)
    {
      ...
      xNodules[numberCells + 1].inList->eindex = (int *)malloc(2 * sizeof(int));
              ...
              for (; plptr != (PLISTPTR)NULL; plptr = plptr->pnext)
                {
                  ...
                  xNodules[cell].inList->eindex = (int *)malloc(2 * sizeof(int));
              ...
              for (; plptr != (PLISTPTR)NULL; plptr = plptr->pnext)
                {
                  ...
                  xNodules[cell].outList->eindex = (int *)malloc(2 * sizeof(int));
          ...
          for (; ofptr != (FLAREPTR)NULL; ofptr = ofptr->next)
            {
              ...
              xNodeArray[inode]->length = edgeList[oedge].loc - edgeList[iedge].loc;
            }
        }
    }
  for (cell = 0; cell <= numberCells + 1; cell++)
