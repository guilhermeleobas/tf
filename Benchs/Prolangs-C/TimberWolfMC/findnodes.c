...
extern void tpop(TNODEPTR *root, TNODEPTR *node, int *value, int *property);
          ...
          for (; vrptr != (DLINK1PTR)NULL; vrptr = vrptr->next)
            {
                           ...
                           (htstart == l &&
                            (edgeList[htedge].fixed == 0 ||
                             (edgeList[htedge].UorR < 0 &&
                              edgeList[edgeList[htedge].nextEdge].UorR < 0)))) &&
                          (htend > r ||
                           (htend == r &&
                            (edgeList[htedge].fixed == 0 ||
                             (edgeList[htedge].UorR < 0 &&
                              edgeList[edgeList[htedge].prevEdge].UorR > 0)))))
                        {
                          ht1 = ht2 = htedge;
                          done = 4;
                        }
                          ...
                          if ((htstart < l ||
                               (htstart == l &&
                                (edgeList[htedge].fixed == 0 ||
                                 (edgeList[htedge].UorR < 0 &&
                                  edgeList[edgeList[htedge].nextEdge].UorR < 0)))) &&
                              (htend > l || (htend == l && edgeList[htedge].fixed == 0)))
                            {
                              if ((htstart < r ||
                                   (htstart == r && edgeList[htedge].fixed == 0)) &&
                                  (htend > r ||
                                   (htend == r &&
                                    (edgeList[htedge].fixed == 0 ||
                                     (edgeList[htedge].UorR < 0 &&
              ...
              if (vlend <= t && lt < l)
                {
                  ...
                  v1ptr = v1ptr->prev;
                  for (; v1ptr != (DLINK1PTR)NULL; v1ptr = v1ptr->prev)
                    {
                      ...
                      if (check)
                        ...
                        {
                          if ((edgeList[v1ptr->edge].fixed == 1) && (bb == t || tt == t))
                            {
                              continue;
                            }
                        }
                  ...
                  for (; v2ptr != (DLINK1PTR)NULL; v2ptr = v2ptr->next)
                    {
                      ...
                      if (check)
                        ...
                        {
                          if ((edgeList[v2ptr->edge].fixed == 1) && (bb == t || tt == t))
                            {
                              continue;
                            }
                        }
              ...
              if (++numRects % 100 == 0)
                {
                  rectArray =
                      (RECTPTR)realloc(rectArray, (numRects + 100) * sizeof(RECT));
                }
...
#ifdef DEBUG
              fprintf(fpdebug, "rect Node: %d  at: %d %d ", numRects,
                      rectArray[numRects].xc, rectArray[numRects].yc);
      ...
      if (rectArray[index].l > last)
        {
          ...
          if (++count % 100 == 0)
            {
              LEptrs =
                  (DLINK2PTR *)realloc(LEptrs, (count + 100) * sizeof(DLINK2PTR));
            }
          LEptrs[count] = leptr;
      ...
      if (rectArray[index].b > last)
        {
          ...
          if (++count % 100 == 0)
            {
              BEptrs =
                  (DLINK2PTR *)realloc(BEptrs, (count + 100) * sizeof(DLINK2PTR));
            }
          BEptrs[count] = beptr;
