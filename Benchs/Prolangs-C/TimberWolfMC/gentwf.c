  ...
  while (fscanf(fp1, " %s ", c6) == 1)
    {
      if (strcmp(c6, "net") == 0)
        ...
        {
          fscanf(fp1, "%s %s %d %s %d %s %d %s %d", pname, c2, &x, c3, &y, c4,
                 &cell, c5, &PorE);
          if (PorE == 1)
            {
          ...
          for (; ifptr != (FLAREPTR)NULL; ifptr = ifptr->next)
            {
              ...
              if (ABS(loc - x) < min)
                {
                  if (y <= rectArray[eArray[ifptr->eindex[1]].index2].yc &&
                      y >= rectArray[eArray[ifptr->eindex[1]].index1].yc)
                    {
                      min = ABS(loc - x);
                      savefptr = ifptr;
                      hit = 1;
          ...
          for (; ofptr != (FLAREPTR)NULL; ofptr = ofptr->next)
            {
              ...
              if (ABS(loc - x) < min)
                {
                  if (y <= rectArray[eArray[ofptr->eindex[1]].index2].yc &&
                      y >= rectArray[eArray[ofptr->eindex[1]].index1].yc)
                    {
                      min = ABS(loc - x);
                      savefptr = ofptr;
                      hit = 1;
          ...
          for (; ifptr != (FLAREPTR)NULL; ifptr = ifptr->next)
            {
              ...
              if (ABS(loc - y) < min)
                {
                  if (x <= rectArray[eArray[ifptr->eindex[1]].index2].xc &&
                      x >= rectArray[eArray[ifptr->eindex[1]].index1].xc)
                    {
                      min = ABS(loc - y);
                      savefptr = ifptr;
                      hit = 2;
          ...
          for (; ofptr != (FLAREPTR)NULL; ofptr = ofptr->next)
            {
              ...
              if (ABS(loc - y) < min)
                {
                  if (x <= rectArray[eArray[ofptr->eindex[1]].index2].xc &&
                      x >= rectArray[eArray[ofptr->eindex[1]].index1].xc)
                    {
                      min = ABS(loc - y);
                      savefptr = ofptr;
                      hit = 2;
