      ...
      if (lArray[nPinLocs].finaly > lArray[1].finaly)
        {
          ...
          else if (bigoY <= lArray[nPinLocs].finaly && litoY >= lArray[1].finaly)
            {
              /*
         ...
         */
            ...
            { /*  only some overlapping exists  */
              /*
         *   Find edge of b.b. inside site.
         */
              if (litoY < lArray[nPinLocs].finaly && litoY > lArray[1].finaly)
                {
                  /*
      ...
      else
        {
          ...
          else if (bigoY <= lArray[1].finaly && litoY >= lArray[nPinLocs].finaly)
            {
              /*
         *   bounding box of net (sans aPin) is
         *   within span of site.  Find nearest loc
         ...
         *   Find edge of b.b. inside site.
         */
              if (litoY < lArray[1].finaly && litoY > lArray[nPinLocs].finaly)
                {
                  /*
           *   Find nearest loc to litoY
           */
      ...
      if (lArray[nPinLocs].finalx > lArray[1].finalx)
        {
          ...
          else if (bigoX <= lArray[nPinLocs].finalx && litoX >= lArray[1].finalx)
            {
              /*
         *   bounding box of net (sans aPin) is
         *   within span of site.  Find nearest loc
         ...
         *   Find edge of b.b. inside site.
         */
              if (litoX < lArray[nPinLocs].finalx && litoX > lArray[1].finalx)
                {
                  /*
      ...
      else
        {
          ...
          else if (bigoX <= lArray[1].finalx && litoX >= lArray[nPinLocs].finalx)
            {
              /*
         *   bounding box of net (sans aPin) is
         *   within span of site.  Find nearest loc
         ...
         *   Find edge of b.b. inside site.
         */
              if (litoX < lArray[1].finalx && litoX > lArray[nPinLocs].finalx)
                {
                  /*
           *   Find nearest loc to litoX
           */
