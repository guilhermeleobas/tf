...
TEAM_TYPE team = {
    {"error", "   "}, {"min", "Minnesota"}, {"atl", "Atlanta"}, {"chi", "Chicago"}, {"dal", "Dallas"}, {"det", "Detroit"}, {"gb", "Green Bay"}, {"ram", "L.A. Rams"}, {"no", "New Orleans"}, {"gia", "N.Y. Giants"}, {"phi", "Philadelphia"}, {"pho", "Phoenix"}, {"sf", "San Francisco"}, {"tb", "Tampa Bay"}, {"was", "Washington"}, {"buf", "Buffalo"}, {"cin", "Cincinnati"}, {"cle", "Cleveland"}, {"den", "Denver"}, {"hou", "Houston"}, {"ind", "Indianapolis"}, {"kc", "Kansas City"}, {"rai", "L.A. Raiders"}, {"mia", "Miami"}, {"ne", "New England"}, {"jet", "N.Y. Jets"}, {"pit", "Pittsburgh"}, {"sd", "San Diego"}, {"sea", "Seattle"}, {"none", "None"}};
