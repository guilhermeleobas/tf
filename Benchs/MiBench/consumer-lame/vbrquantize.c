...
#define DEBUGXX
FLOAT8 calc_sfb_ave_noise(FLOAT8 *xr, FLOAT8 *xr34, int stride, int bw,
                          FLOAT8 sfpow)
{
  int j;
  FLOAT8 xfsf = 0;
...
*/
FLOAT8 compute_scalefacs_long(FLOAT8 vbrsf[SBPSY_l], gr_info *cod_info,
 ...
 *
 ************************************************************************/
void VBR_iteration_loop_new(lame_global_flags *gfp, FLOAT8 pe[2][2],
