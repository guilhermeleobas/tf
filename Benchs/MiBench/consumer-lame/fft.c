...
#define ch2(index) \
  (((FLOAT)(0.5 * SQRT2)) * (buffer[0][index] + buffer[1][index]))
#define ch3(index) \
  (((FLOAT)(0.5 * SQRT2)) * (buffer[0][index] - buffer[1][index]))
...
void fft_short(FLOAT x_real[3][BLKSIZE_s], int chn, short *buffer[2])
{
  short i, j, b;
...
void fft_long(FLOAT x[BLKSIZE], int chn, short *buffer[2])
{
