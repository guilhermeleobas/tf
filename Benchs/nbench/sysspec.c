              ...
              int *errorcode) /* Returned error code */
{
  ...
  */
  ...
  if (readcode == -1) *errorcode = ERROR_FILEREAD;
              ...
              int *errorcode) /* Returned error code */
{
  ...
  */
  ...
  if (readcode != nelems) *errorcode = ERROR_FILEREAD;
               ...
               int *errorcode) /* Returned error code */
{
  ...
  */
  ...
  if (writecode == -1) *errorcode = ERROR_FILEWRITE;
               ...
               int *errorcode) /* Returned error code */
{
  ...
  */
  ...
  if (writecode == nelems) *errorcode = ERROR_FILEWRITE;
