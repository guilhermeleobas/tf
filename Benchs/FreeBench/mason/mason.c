...
static p_type m1u(p_type p) { return p; }
static p_type m2u(p_type p)
{
  int m[] = {1, 2, 9, 10, 4, 17, 6, 0, 8, 15, 11, 12, 5, 13, 7, 14, 3, 16};
  p_type pu;
...
{
  int m[] = {0, 2, 3, 10, 11, 5, 17, 7, 1, 9, 15, 12, 13, 6, 8, 14, 4, 16};
  p_type pu;
...
static p_type m1d(p_type p) { return p; }
static p_type m2d(p_type p)
{
  int m[] = {7, 0, 1, 16, 4, 12, 6, 14, 8, 2, 3, 10, 11, 13, 15, 9, 17, 5};
  p_type pu;
...
#define KKK 4
  /* 2 :
   * {0x40,0x40,0x40,0x60,0x0,0x5,0xa,0x50,0x70,0x70,0x24,0xc,0x9,0xe,0x20,0x10,0x1,0x3};
   */
