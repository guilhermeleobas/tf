...
static int FPEqual(double d1, double d2) { return fabs(d1 - d2) < 0.000001L; }
...
void CalcObjectChildren(ObjPtr o, double sx, double sy, double sz, double ax,
                        double ay, double az, double dx, double dy, double dz)
{
  ObjPtr tmp = NULL;
  if (o != NULL)
  {
