...
float Falign(char **seq1, char **seq2, double *eff1, double *eff2, int clus1,
             int clus2, int alloclen, int *fftlog)
{
  int i, j, k, l, m, maxk;
  int nlen, nlen2, nlen4;
...
float Falign_noudp(char **seq1, char **seq2, double *eff1, double *eff2,
                   int clus1, int clus2, int alloclen, int *fftlog)
{
  int i, j, k, l, m, maxk;
  int nlen, nlen2, nlen4;
  static int prevalloclen = 0;
...
float Falign_udpari_long(char **seq1, char **seq2, double *eff1, double *eff2,
                         int clus1, int clus2, int alloclen, int *fftlog)
{
  int i, j, k, l, m, maxk;
  int nlen, nlen2, nlen4;
