...
void FreeFloatVec(float *vec) { free((char *)vec); }
...
void FreeIntVec(int *vec) { free((char *)vec); }
...
void FreeDoubleVec(double *vec) { free(vec); }
...
void FreeShortVec(short *vec) { free((char *)vec); }
