...
void imp_match_init_strictR(float *imp, int clus1, int clus2, int lgth1,
...
float R__align(char **seq1, char **seq2, double *eff1, double *eff2, int icyc,
      ...
      for (i = 1; i < lgth1 + 1; i++)
        {
          ...
          //	Q		tmppenal = (
          //(1.0-gapz2[1])*(1.0-fgcp1g[i]+ogcp1g[i]-digf1[i]) ) * 0.5 * fpenalty; //
          //mada
          //			tmppenal = (
          //(1.0-gapf2[j])*(1.0-fgcp1g[i]+ogcp1g[i]) +
          //gapf2[j]*(1.0-digf1[i]-diaf1[i]) ) * 0.5 * fpenalty; // mada
          tmppenal = ((1.0 - gapz2[1]) * (1.0 - fgcp1g[i] + ogcp1g[i]) +
                      gapz2[1] * (1.0 - digf1[i] - diaf1[i])) *
                     0.5 * fpenalty;  // mada
          //			tmppenal = (
          ...
          initverticalw[i] +=
              cumpenal - fgcp1g[i] * fpenalty * 0.5;  // honto ha iru
      ...
      for (j = 1; j < lgth2 + 1; j++)
        {
          ...
          //			tmppenal = (
          //(1.0-gapz1[1])*(1.0-fgcp2g[j]+ogcp2g[j]-digf2[j]) ) * 0.5 * fpenalty; //
          //mada
          //			tmppenal = (
          //(1.0-gapf1[i])*(1.0-fgcp2g[j]+ogcp2g[j]) +
          //gapf1[i]*(1.0-digf2[j]-diaf2[j]) ) * 0.5 * fpenalty; // mada
          tmppenal = ((1.0 - gapz1[1]) * (1.0 - fgcp2g[j] + ogcp2g[j]) +
                      gapz1[1] * (1.0 - digf2[j] - diaf2[j])) *
                     0.5 * fpenalty;  // mada
          //			tmppenal = (
      ...
      for (j = 1; j < lastj; j++)
        {
          ...
          *ijppt = 0;
...
#endif
          //			tmppenal = (
          //(1.0-gapz1[i+1])*(1.0-fgcp2g[j]+ogcp2g[j]-digf2[j]) ) * 0.5 * fpenalty;
          //// mada
          //			tmppenal = ( (1.0-gapf1[i])*(1.0-fgcp2g[j]) +
          //gapf1[i]*(1.0-digf2[j]-diaf2[j]) ) * 0.5 * fpenalty; // mada
          tmppenal = ((1.0 - gapz1[i + 1]) * (1.0 - fgcp2g[j] + ogcp2g[j]) +
                      gapz1[i + 1] * (1.0 - digf2[j] - diaf2[j])) *
                     0.5 * fpenalty;  // mada
          //			tmppenal = (
          //(1.0-gapf1[i])*(1.0-fgcp2g[j]+ogcp2g[j]) +
          //gapf1[i]*(1.0-digf2[j]-diaf2[j]) ) * 0.5 * fpenalty; // mada
          //			tmppenal = 0.5 * fpenalty;
          //			tmppenal -= ( (1.0-gapf1[i])*(1.0-diaf2[j]) +
          //gapf1[i] ) * 0.5 * fpenalty;
          //			tmppenal -= ( (1.0-gapf1[i])*fgcp2g[j] +
          //gapf1[i] ) * 0.5 * fpenalty;
          //			tmppenal = *fgcp2pt-fpenalty*0.5*gapf1[i];
          //			tmppenal = *fgcp2pt;
          if ((g = mi + tmppenal) > wm)
            {
              //				fprintf( stderr, "jump i start=%f (j=%d,
              //fgcp2g[j]=%f, digf2[j]=%f, diaf2[j]=%f), %c-%c\n", g-mi, j, fgcp2g[j],
              //digf2[j], diaf2[j], seq1[0][i], seq2[0][j] );
              wm = g;
              *ijppt = -(j - mpi);
            }
          //			tmppenal = (
          //(1.0-gapz1[i])*(1.0-ogcp2g[j]+fgcp2g[j]-digf2[j]) ) * 0.5 * fpenalty; //
          //mada
          tmppenal = ((1.0 - gapz1[i]) * (1.0 - ogcp2g[j] + fgcp2g[j]) +
                      gapz1[i] * (1.0 - digf2[j] - diaf2[j])) *
                     0.5 * fpenalty;  // mada
          //			tmppenal = (
          //(1.0-gapf1[i-1])*(1.0-ogcp2g[j]+fgcp2g[j]) +
          //gapf1[i-1]*(1.0-digf2[j]-diaf2[j]) ) * 0.5 * fpenalty; // mada
          //			tmppenal =
          //*ogcp2pt-fpenalty*0.5*(gapf2[j-1]+gapf1[i-1]);
          //			tmppenal = 0.5 * fpenalty;
          //			tmppenal -= ( (1.0-gapf1[i-1])*(1.0-diaf2[j]) +
          //gapf1[i-1] ) * 0.5 * fpenalty;
          //			tmppenal -= ( (1.0-gapf1[i-1])*ogcp2g[j] +
          //gapf1[i-1] ) * 0.5 * fpenalty;
          ...
          if ((g = *prept + tmppenal) >= mi)
            ...
            {
              mi +=
                  (ogcp2g[j - 0] + fgcp2g[j]) * fpenalty * 0.5;  // CHUUI honto ha iru
...
#endif
          //			tmppenal = (
          //(1.0-gapz2[j+1])*(1.0-fgcp1g[i]+ogcp1g[i]-digf1[i]) ) * 0.5 * fpenalty;
          //// mada
          tmppenal = ((1.0 - gapz2[j + 1]) * (1.0 - fgcp1g[i] + ogcp1g[i]) +
                      gapz2[j + 1] * (1.0 - digf1[i] - diaf1[i])) *
                     0.5 * fpenalty;  // mada
          //			tmppenal = (
          //(1.0-gapf2[j])*(1.0-fgcp1g[i]+ogcp1g[i]) +
          //gapf2[j]*(1.0-digf1[i]-diaf1[i]) ) * 0.5 * fpenalty; // mada
          //			tmppenal = ( (1.0-gapf2[j])*(1.0-fgcp1g[i]) +
          //gapf2[j]*(1.0-digf1[i]-diaf1[i]) ) * 0.5 * fpenalty; // mada
          //			tmppenal = 0.5 * fpenalty;
          //			tmppenal -= ( (1.0-gapf2[j])*(1.0-diaf1[i]) +
          //gapf2[j] ) * 0.5 * fpenalty;
          //			tmppenal -= ( (1.0-gapf2[j])*fgcp1g[i] +
          //gapf2[j] ) * 0.5 * fpenalty;
          ...
          if ((g = *mjpt + tmppenal) > wm)
            {
              ...
              //)
              //					fprintf( stderr, "jump j start=%f,
              //%c-%c\n", g-*mjpt, seq1[0][i], seq2[0][j] );
              wm = g;
              *ijppt = +(i - *mpjpt);
            }
          //			tmppenal = (
          //(1.0-gapz2[j])*(1.0-ogcp1g[i]+fgcp1g[i]-digf1[i]) ) * 0.5 * fpenalty; //
          //mada
          tmppenal = ((1.0 - gapz2[j]) * (1.0 - ogcp1g[i] + fgcp1g[i]) +
                      gapz2[j] * (1.0 - digf1[i] - diaf1[i])) *
                     0.5 * fpenalty;  // mada
          //			tmppenal = (
          //(1.0-gapf2[j-1])*(1.0-ogcp1g[i]+fgcp1g[i]) +
          //gapf2[j-1]*(1.0-digf1[i]-diaf1[i]) ) * 0.5 * fpenalty; // mada
          //			tmppenal = ( (1.0-gapf2[j-1])*(1.0-ogcp1g[i]) +
          //gapf2[j-1]*(1.0-digf1[i]-diaf1[i]) ) * 0.5 * fpenalty; // mada
          //			tmppenal =
          //ogcp1va-fpenalty*0.5*(gapf1[i-1]+gapf2[j-1]);
          //			tmppenal = 0.5 * fpenalty;
          //			tmppenal -= ( (1.0-gapf2[j-1]) * (1.0-diaf1[i])
          //+ gapf2[j-1] ) * 0.5 * fpenalty;
          //			tmppenal -= ( (1.0-gapf2[j-1]) * ogcp1g[i] +
          //gapf2[j-1] ) * 0.5 * fpenalty;
          //			tmppenal = 0.5 * fpenalty - ( (1.0-gapf2[j-1]) *
          //(ogcp1g[i]) + gapf2[j-1] ) * ( 0.5 * fpenalty );
          ...
          if ((g = *prept + tmppenal) >= *mjpt)
            ...
            {
              m[j] +=
                  (ogcp1g[i - 0] + fgcp1g[i]) * fpenalty * 0.5;  // CHUUI honto ha iru
              //				fprintf( stderr, "%c%c/%c%c exp,
