...
int hypre_SMGSetBase(void *smg_vdata, hypre_Index base_index,
...
int hypre_SMGGetFinalRelativeResidualNorm(void *smg_vdata,
...
int hypre_SMGSetStructVectorConstantValues(hypre_StructVector *vector,
                                           double values,
