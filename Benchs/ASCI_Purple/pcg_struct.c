...
int hypre_StructKrylovMatvec(void *matvec_data, double alpha, void *A, void *x,
                             double beta, void *y)
{
  return (hypre_StructMatvecCompute(matvec_data, alpha, (hypre_StructMatrix *)A,
...
{
  return (hypre_StructVectorSetConstantValues((hypre_StructVector *)x, 0.0));
}
