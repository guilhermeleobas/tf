...
hypre_StructStencil *hypre_StructStencilCreate(int dim, int size,
                                               hypre_Index *shape)
{
...
int hypre_StructStencilElementRank(hypre_StructStencil *stencil,
...
int hypre_StructStencilSymmetrize(hypre_StructStencil *stencil,
                                  ...
                                  int **symm_elements_ptr)
{
  ...
  for (i = 0; i < 2 * stencil_size; i++) symm_elements[i] = -1;
