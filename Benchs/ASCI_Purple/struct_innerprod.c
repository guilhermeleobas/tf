...
double hypre_StructInnerProd(hypre_StructVector *x, hypre_StructVector *y)
{
  ...
  hypre_ForBoxI(i, boxes)
  {
    ...
    hypre_BoxLoop2Begin(loop_size, x_data_box, start, unit_stride, xi,
...
#include "hypre_box_smp_forloop.h"
  ...
  MPI_Allreduce(&process_result, &final_innerprod_result, 1, MPI_DOUBLE,
                MPI_SUM, hypre_StructVectorComm(x));
