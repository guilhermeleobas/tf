...
int HYPRE_StructMatrixCreate(MPI_Comm comm, HYPRE_StructGrid grid,
...
int HYPRE_StructMatrixSetValues(HYPRE_StructMatrix matrix, int *grid_index,
                                int num_stencil_indices, int *stencil_indices,
                                double *values)
{
  ...
  ierr = hypre_StructMatrixSetValues(
      matrix, new_grid_index, num_stencil_indices, stencil_indices, values, 0);
...
int HYPRE_StructMatrixSetBoxValues(HYPRE_StructMatrix matrix, int *ilower,
                                   int *iupper, int num_stencil_indices,
                                   int *stencil_indices, double *values)
{
  ...
  ierr = hypre_StructMatrixSetBoxValues(
      matrix, new_value_box, num_stencil_indices, stencil_indices, values, 0);
...
int HYPRE_StructMatrixAddToValues(HYPRE_StructMatrix matrix, int *grid_index,
                                  int num_stencil_indices, int *stencil_indices,
                                  double *values)
{
  hypre_Index new_grid_index;
  ...
  ierr = hypre_StructMatrixSetValues(
      matrix, new_grid_index, num_stencil_indices, stencil_indices, values, 1);
...
int HYPRE_StructMatrixAddToBoxValues(HYPRE_StructMatrix matrix, int *ilower,
                                     int *iupper, int num_stencil_indices,
                                     int *stencil_indices, double *values)
{
  hypre_Index new_ilower;
  ...
  ierr = hypre_StructMatrixSetBoxValues(
      matrix, new_value_box, num_stencil_indices, stencil_indices, values, 1);
