...
int hypre_SMGRelax(void *relax_vdata, hypre_StructMatrix *A,
...
int hypre_SMGRelaxSetup(void *relax_vdata, hypre_StructMatrix *A,
                        hypre_StructVector *b, hypre_StructVector *x)
{
  hypre_SMGRelaxData *relax_data = relax_vdata;
  int stencil_dim;
...
int hypre_SMGRelaxSetupTempVec(void *relax_vdata, hypre_StructMatrix *A,
                               hypre_StructVector *b, hypre_StructVector *x)
{
  hypre_SMGRelaxData *relax_data = relax_vdata;
...
int hypre_SMGRelaxSetupARem(void *relax_vdata, hypre_StructMatrix *A,
                            hypre_StructVector *b, hypre_StructVector *x)
{
  hypre_SMGRelaxData *relax_data = relax_vdata;
...
int hypre_SMGRelaxSetupASol(void *relax_vdata, hypre_StructMatrix *A,
                            hypre_StructVector *b, hypre_StructVector *x)
{
  hypre_SMGRelaxData *relax_data = relax_vdata;
...
int hypre_SMGRelaxSetNumPreSpaces(void *relax_vdata, int num_pre_spaces)
{
  ...
  for (i = 0; i < num_pre_spaces; i++) (relax_data->pre_space_ranks[i]) = 0;
...
int hypre_SMGRelaxSetNumRegSpaces(void *relax_vdata, int num_reg_spaces)
{
  ...
  for (i = 0; i < num_reg_spaces; i++) (relax_data->reg_space_ranks[i]) = 0;
...
int hypre_SMGRelaxSetSpace(void *relax_vdata, int i, int space_index,
                           int space_stride)
{
  hypre_SMGRelaxData *relax_data = relax_vdata;
  int ierr = 0;
...
int hypre_SMGRelaxSetBase(void *relax_vdata, hypre_Index base_index,
                          hypre_Index base_stride)
{
  hypre_SMGRelaxData *relax_data = relax_vdata;
  int d;
...
int hypre_SMGRelaxSetupBaseBoxArray(void *relax_vdata, hypre_StructMatrix *A,
                                    hypre_StructVector *b,
                                    hypre_StructVector *x)
{
  hypre_SMGRelaxData *relax_data = relax_vdata;
  ...
  hypre_ProjectBoxArray(base_box_array, (relax_data->base_index),
