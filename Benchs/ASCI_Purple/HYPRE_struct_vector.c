...
int HYPRE_StructVectorSetValues(HYPRE_StructVector vector, int *grid_index,
                                double values)
{
...
int HYPRE_StructVectorSetBoxValues(HYPRE_StructVector vector, int *ilower,
...
int HYPRE_StructVectorAddToValues(HYPRE_StructVector vector, int *grid_index,
                                  double values)
{
  hypre_Index new_grid_index;
...
int HYPRE_StructVectorAddToBoxValues(HYPRE_StructVector vector, int *ilower,
                                     int *iupper, double *values)
{
  hypre_Index new_ilower;
  hypre_Index new_iupper;
...
int HYPRE_StructVectorGetValues(HYPRE_StructVector vector, int *grid_index,
                                double *values_ptr)
{
  hypre_Index new_grid_index;
...
int HYPRE_StructVectorGetBoxValues(HYPRE_StructVector vector, int *ilower,
                                   int *iupper, double *values)
{
  hypre_Index new_ilower;
  hypre_Index new_iupper;
