...
int hypre_StructMapFineToCoarse(hypre_Index findex, hypre_Index index,
                                hypre_Index stride, hypre_Index cindex)
{
  hypre_IndexX(cindex) =
...
int hypre_StructMapCoarseToFine(hypre_Index cindex, hypre_Index index,
                                hypre_Index stride, hypre_Index findex)
{
  hypre_IndexX(findex) =
...
int hypre_StructCoarsen(hypre_StructGrid *fgrid, hypre_Index index,
                        hypre_Index stride, int prune,
...
/* always communicate */
  ...
  /* set neighborhood */
  hypre_StructGridSetHood(cgrid, hood_boxes, hood_procs, hood_ids, first_local,
                          num_local, num_periodic, bounding_box);
