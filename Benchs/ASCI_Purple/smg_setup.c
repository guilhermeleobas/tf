...
int hypre_SMGSetup(void *smg_vdata, hypre_StructMatrix *A,
  ...
  for (l = 0; l < (num_levels - 1); l++)
    {
      ...
      hypre_SMGRelaxSetSpace(relax_data_l[l], 0, hypre_IndexD(cindex, cdir),
                             hypre_IndexD(stride, cdir));
      hypre_SMGRelaxSetSpace(relax_data_l[l], 1, hypre_IndexD(findex, cdir),
                             hypre_IndexD(stride, cdir));
      ...
      hypre_SMGSetupInterpOp(relax_data_l[l], A_l[l], b_l[l], x_l[l], PT_l[l],
                             cdir, cindex, findex, stride);
...
/* set up the restriction operator */
      ...
      hypre_SMGSetupRAPOp(R_l[l], A_l[l], PT_l[l], A_l[l + 1], cindex, stride);
    }
