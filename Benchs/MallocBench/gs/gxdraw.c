...
/* Fill a rectangle. */
int gz_fill_rectangle(int x, int y, int w, int h, gx_device_color *pdevc,
                      gs_state *pgs)
{
...
int gz_fill_trapezoid_fixed(fixed fx0, fixed fw0, fixed fy0, fixed fx1,
                            fixed fw1, fixed fh, int swap_axes,
...
int gx_default_tile_rectangle(gx_device *dev, register gx_bitmap *tile, int x,
...
{ /* Fill the rectangle in chunks */
  ...
  int (*proc_mono)(P10(gx_device *, byte *, int, int, int, int, int, int,
                       gx_color_index, gx_color_index));
  int (*proc_color)(P8(gx_device *, byte *, int, int, int, int, int, int));
  int color_halftone =
...
int gz_draw_line_fixed(fixed ixf, fixed iyf, fixed itoxf, fixed itoyf,
                       gx_device_color *pdevc, gs_state *pgs)
{
...
int gx_default_fill_trapezoid(gx_device *dev, int x0, int y0, int width0,
                              int x1, int y1, int width1, gx_color_index color)
{
  return -1;
}
int gx_default_tile_trapezoid(gx_device *dev, gx_bitmap *tile, int x0, int y0,
                              int width0, int x1, int y1, int width1,
                              gx_color_index color0, gx_color_index color1)
{
  return -1;
}
int gx_default_tile_trapezoid_color(gx_device *dev, gx_bitmap *tile, int x0,
                                    int y0, int width0, int x1, int y1,
                                    int width1)
{
  return -1;
}
