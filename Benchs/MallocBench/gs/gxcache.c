...
cached_char *gx_alloc_char_bits(gs_font_dir *dir, gx_device_memory *dev,
...
void gx_unalloc_cached_char(gs_font_dir *dir, cached_char *cc)
{
...
cached_fm_pair *gx_lookup_fm_pair(register gs_state *pgs)
{
...
void gx_add_cached_char(gs_font_dir *dir, cached_char *cc, cached_fm_pair *pair)
...
cached_char *gx_lookup_cached_char(gs_state *pgs, cached_fm_pair *pair,
                                   int ccode)
{
...
int gx_copy_cached_char(register gs_show_enum *penum, register cached_char *cc)
{
...
private
void zap_cache(register gs_font_dir *dir)
{
  dir->bsize = 0;
  dir->msize = 0;
  dir->csize = 0;
