...
/* Create a dictionary */
int dict_create(uint size, ref *pref)
{
...
/* for a dictionary. */
ref *dict_access_ref(ref *pdref) { return &pdref->value.pdict->contents; }
...
int dict_lookup(ref *pdbot, ref *pdtop, ref *pkey,
...
int dict_put(ref *pdref /* t_dictionary */, ref *pkey, ref *pvalue)
{
  ref *pvslot;
...
uint dict_maxlength(ref *pdref /* t_dictionary */)
{
  return npairs(pdref->value.pdict);
}

/* Copy one dictionary into another. */
int dict_copy(ref *pdrfrom /* t_dictionary */, ref *pdrto /* t_dictionary */)
{
...
/* Resize a dictionary */
int dict_resize(ref *pdrfrom, uint new_size)
{
  dict *pdict = pdrfrom->value.pdict;
  ref drto;
  int code;
