...
#define rand_step() (rand_state = rand_state * 0x41c64e6dL + 0x3039)
  value = rand_step() << 21;
  value += rand_step() << 10;
  value += rand_step() >> 3;
  value &= 0x7fffffffL;
