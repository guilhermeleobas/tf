...
private
long proc_reloc; /* relocation of procedures */

int gs_main(int argc, char *argv[], char *map_name,
...
/* If debugging is enabled, trace the device calls. */
#ifdef DEBUG
  {
    ...
    extern gx_device_memory mem_mono_device, mem_mapped_color_device,
        mem_true24_color_device, mem_true32_color_device;
    static gx_device_memory *mdevs[5] = {
        &mem_mono_device, &mem_mapped_color_device, &mem_true24_color_device,
        &mem_true32_color_device, 0};
    gx_device **pdevs[3];
    gx_device ***ppdev;
    gx_device **pdev;
