...
private
byte mb2[4] = {0xaa, 0xaa, 0x55, 0x55};
private
byte mb3[6] = {0x92, 0x49, 0x49, 0x24, 0x24, 0x92};
private
byte mb4[8] = {0x88, 0x88, 0x44, 0x44, 0x22, 0x22, 0x11, 0x11};
private
byte mb5[10] = {0x84, 0x21, 0x42, 0x10, 0x21, 0x08, 0x10, 0x84, 0x08, 0x42};
private
byte mb6[12] = {0x82, 0x08, 0x41, 0x04, 0x20, 0x82,
                0x10, 0x41, 0x08, 0x20, 0x04, 0x10};
private
byte mb7[14] = {0x81, 0x02, 0x40, 0x81, 0x20, 0x40, 0x10,
                0x20, 0x08, 0x10, 0x04, 0x08, 0x02, 0x04};
private
byte mb8[16] = {0x80, 0x80, 0x40, 0x40, 0x20, 0x20, 0x10, 0x10,
                0x08, 0x08, 0x04, 0x04, 0x02, 0x02, 0x01, 0x01};
private
bit16 *multi_bits[9] = {0,
                        (bit16 *)mb1,
                        (bit16 *)mb2,
                        (bit16 *)mb3,
                        (bit16 *)mb4,
...
int gx_ht_construct_order(ht_bit *order, int width, int height)
{
  uint i;
...
private
void render_ht(P3(bit_tile *, int, halftone *));
private
void init_ht(P2(ht_cache *, halftone *));
void gx_color_load(register gx_device_color *pdevc, gs_state *pgs)
{
...
private
void init_ht(ht_cache *pcache, halftone *pht)
{
  int width = pht->width;
 ...
 */
private
void render_ht(bit_tile *pbt, int level /* [1..order_size-1] */, halftone *pht)
{
