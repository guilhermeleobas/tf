...
/* setscreen */
int zsetscreen(register ref *op)
{
  float fa[2];
...
private
int screen_sample(register ref *op)
{
...
private
int set_screen_continue(register ref *op)
{
  float value;
...
void zht_op_init()
{
  static op_def my_defs[] = {{"3setscreen", zsetscreen}, op_def_end};
  z_op_init(my_defs);
}
