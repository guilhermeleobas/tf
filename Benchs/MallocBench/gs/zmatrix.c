...
/* currentmatrix */
int zcurrentmatrix(register ref *op)
{
...
/* setmatrix */
int zsetmatrix(register ref *op)
{
  gs_matrix mat;
...
/* translate */
int ztranslate(register ref *op)
{
  int code = write_matrix(op);
  float trans[2];
...
/* concatmatrix */
int zconcatmatrix(register ref *op)
{
  gs_matrix m1, m2;
  int code;
...
private
int common_transform(register ref *op,
                     int (*ptproc)(P4(gs_state *, floatp, floatp, gs_point *)),
                     int (*matproc)(P4(floatp, floatp, gs_matrix *,
                                       gs_point *)))
{
  float opxy[2];
  gs_point pt;
...
/* invertmatrix */
int zinvertmatrix(register ref *op)
{
  gs_matrix m;
  int code;
...
void zmatrix_op_init()
{
  static op_def my_defs[] = {{"1concat", zconcat},
