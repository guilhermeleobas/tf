...
/* for */
private
int for_int_continue(P1(ref *)), for_real_continue(P1(ref *));
int zfor(register ref *op)
{
...
private
int for_int_continue(register ref *op)
{
  ref proc;
...
private
int for_real_continue(register ref *op)
{
  ref proc;
...
/* repeat */
private
int repeat_continue(P1(ref *));
int zrepeat(register ref *op)
{
...
/* loop */
private
int loop_continue(P1(ref *));
int zloop(register ref *op)
{
  check_op(1);
  check_estack(4);
...
/* countexecstack */
int zcountexecstack(register ref *op)
{
  push(1);
...
/* execstack */
private
int continue_execstack(P1(ref *));
int zexecstack(register ref *op)
...
private
int continue_execstack(register ref *op)
{
...
/* quit */
int zquit(register ref *op) { gs_exit(0); }
/* ------ Initialization procedure ------ */

void zcontrol_op_init()
{
  static op_def my_defs[] = {{"0countexecstack", zcountexecstack},
                             {"1exec", zexec},
