...
/* anchorsearch */
int zanchorsearch(register ref *op)
{
  ref *op1 = op - 1;
  uint size = op->size;
...
void zstring_op_init()
{
  static op_def my_defs[] = {{"2anchorsearch", zanchorsearch},
                             {"2search", zsearch},
                             {"1string", zstring},
                             {"1token", ztoken},
                             op_def_end};
