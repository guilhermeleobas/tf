...
private
int make_color(P1(ref *));

/* currentgscolor */
int zcurrentgscolor(register ref *op)
{
  int code;
  push(1);
...
/* setgscolor */
int zsetgscolor(register ref *op)
{
  int code;
...
void zcolor_op_init()
{
  static op_def my_defs[] = {{"0currentgscolor", zcurrentgscolor},
