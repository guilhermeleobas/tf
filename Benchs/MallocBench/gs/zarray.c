...
void zarray_op_init()
{
  static op_def my_defs[] = {
      {"1aload", zaload}, {"1array", zarray}, {"1astore", zastore}, op_def_end};
  z_op_init(my_defs);
}
...
int make_array(register ref *op, int type, int attrs, char *client_name)
{
  ref *abody;
  uint size;
