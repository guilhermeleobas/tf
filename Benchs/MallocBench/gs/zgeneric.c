...
/* getinterval */
int zgetinterval(register ref *op)
{
  ref *op1 = op - 1;
  ref *op2 = op1 - 1;
  uint index;
...
/* putinterval */
int zputinterval(register ref *op)
{
  ref *opindex = op - 1;
  ref *opto = opindex - 1;
  int code;
...
/* forall */
private
int array_continue(P1(ref *)), string_continue(P1(ref *)),
    dict_continue(P1(ref *));
int zforall(register ref *op)
{
  int (*cproc)(P1(ref *));
  ref *obj = op - 1;
  uint index;
...
private
int array_continue(register ref *op)
{
  ref *obj = esp - 2;
...
private
int string_continue(register ref *op)
{
  ref *obj = esp - 2;
  if (obj->size--) /* continue */
    {
...
private
int dict_continue(register ref *op)
{
  ref *obj = esp - 2;
...
void zgeneric_op_init()
{
  static op_def my_defs[] = {{"1copy", zcopy},
                             {"2forall", zforall},
                             {"2get", zget},
