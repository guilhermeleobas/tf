 ...
 *   or EOF if error
 */
static int fouts(stream, chp) FILE *stream;
register char *chp;
{
 ...
 */
int fputp(stream, p) FILE *stream;
precision p;
{
  int res;
 ...
 */
int fprintp(stream, p, minWidth) FILE *stream;
precision p;
 ...
 */
precision fgetp(stream) FILE *stream;
{
