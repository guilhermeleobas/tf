...
#ifdef __STDC__
extern unsigned *pfactorbase(precision n, unsigned k, unsigned *m,
                             unsigned aborts);
 ...
 */
float pfKnuthEx28(p, d) unsigned p;
precision d;
{
  register float res;
  precision k = pUndef;
 ...
 */
unsigned findk(n, m, aborts, maxk) precision n;
register unsigned *m;
