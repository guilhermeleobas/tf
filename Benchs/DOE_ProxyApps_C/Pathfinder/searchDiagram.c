 ...
 * simply iterates through the entire list, there is no optimization in the
 * search
 * algorithm.
 */
...
SearchDiagram *SearchDiagram_build(NodeList *nodeTree, int nodeCount)
{
  ...
  /* Scream through the Nodes and fill in the Search Array allocate space for
   * edges */
