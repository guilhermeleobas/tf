      ...
      /*
         ...
         average[42]);
               ...
               printf("     Blocks/timestep ave, min, max : %lf %d %d\n",
                      ((double) total_blocks)/((double)
         (num_tsteps*stages_per_ts)),
                      nb_min, nb_max);
