...
int read_x_bits(unsigned char* buf, int offset, int x)
{                                                      /*1*/
...
int read_11_bits(unsigned char* buf, int offset)
{                                                   /*14*/
  ...
  return (res | (b1 << (3 - ioffset)) | b2 >> (ioffset + 5)) &
         ((1 << 11) - 1); /*25*/
}

linked_list_lli* five11(unsigned char* inbuf)
{                                                    /*26*/
...
int pad_size(int nof_channels)
{                                   /*44*/
  int bits = 5 + nof_channels * 11; /*45*/
  return ((8 - (bits & 7)) & 7);    /*46*/
}

int calc_sum2(linked_list_lli* list)
{                        /*47*/
...
int calc_sum1(linked_list_int* list)
{                        /*56*/
