...
int Get_macroblock_type()
{
  ...
  else
  {
    ...
    {
      case I_TYPE:
        macroblock_type = ld->pict_scal ? Get_I_Spatial_macroblock_type()
                                        : Get_I_macroblock_type();
        break;
      case P_TYPE:
        macroblock_type = ld->pict_scal ? Get_P_Spatial_macroblock_type()
                                        : Get_P_macroblock_type();
        break;
      case B_TYPE:
        macroblock_type = ld->pict_scal ? Get_B_Spatial_macroblock_type()
...
{
#ifdef TRACE
  if (Trace_Flag) printf("macroblock_type(I) ");
#endif /* TRACE */

  if (Get_Bits1())
  {
#ifdef TRACE
    if (Trace_Flag) printf("(1): Intra (1)\n");
#endif /* TRACE */
    return 1;
  }
...
#ifdef TRACE
  if (Trace_Flag) printf("(01): Intra, Quant (17)\n");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag) printf("macroblock_type(P) (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag) printf("macroblock_type(B) (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag) printf("macroblock_type(I,spat) (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag) printf("macroblock_type(P,spat) (");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag) printf("macroblock_type(B,spat) (");
#endif /* TRACE */
...
#ifdef TRACE /* *CH* */
  if (Trace_Flag) printf("macroblock_type(SNR) (");
#endif  // TRACE
...
int Get_motion_code()
{
...
#ifdef TRACE
  if (Trace_Flag) printf("motion_code (");
#endif /* TRACE */

  if (Get_Bits1())
  {
#ifdef TRACE
    if (Trace_Flag) printf("0): 0\n");
#endif /* TRACE */
    return 0;
  }
  ...
  if ((code = Show_Bits(9)) >= 64)
  {
    ...
    if (Trace_Flag)
    {
      ...
      printf("%d): %d\n", Show_Bits(1),
             Show_Bits(1) ? -MVtab0[code].val : MVtab0[code].val);
    }
#endif /* TRACE */
  ...
  if (code >= 24)
  {
    ...
    if (Trace_Flag)
    {
      ...
      printf("%d): %d\n", Show_Bits(1),
             Show_Bits(1) ? -MVtab1[code].val : MVtab1[code].val);
    }
#endif /* TRACE */
  ...
  if (Trace_Flag)
  {
    ...
    printf("%d): %d\n", Show_Bits(1),
           Show_Bits(1) ? -MVtab2[code].val : MVtab2[code].val);
  }
#endif /* TRACE */
...
{
#ifdef TRACE
  if (Trace_Flag) printf("dmvector (");
#endif /* TRACE */

  if (Get_Bits(1))
  {
#ifdef TRACE
    if (Trace_Flag) printf(Show_Bits(1) ? "11): -1\n" : "10): 1\n");
#endif /* TRACE */
...
#ifdef TRACE
  if (Trace_Flag) printf("coded_block_pattern_420 (");
#endif /* TRACE */
...
int Get_macroblock_address_increment()
{
...
#ifdef TRACE
  if (Trace_Flag) printf("macroblock_address_increment (");
#endif /* TRACE */
  ...
  while ((code = Show_Bits(11)) < 24)
  {
    if (code != 15) /* if not macroblock_stuffing */
    {
      ...
      {
#ifdef TRACE
        if (Trace_Flag) printf("00000001000 ");
#endif /* TRACE */
    ...
    {
#ifdef TRACE
      if (Trace_Flag) printf("00000001111 ");
#endif /* TRACE */
    }
