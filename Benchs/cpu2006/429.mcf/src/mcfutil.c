...
#else
void refresh_neighbour_lists(net) network_t *net;
#endif
{
  node_t *node;
  arc_t *arc;
...
#else
long refresh_potential(net) network_t *net;
#endif
{
  node_t *node, *tmp;
...
#else
double flow_cost(net) network_t *net;
#endif
{
  arc_t *arc;
  node_t *node;
...
#else
double flow_org_cost(net) network_t *net;
#endif
{
  arc_t *arc;
  node_t *node;
...
#else
long primal_feasible(net) network_t *net;
#endif
{
  void *stop;
  node_t *node;
...
#else
long dual_feasible(net) network_t *net;
#endif
{
  arc_t *arc;
