...
function compile() {
  ...
  # alias_analysis="-basicaa -globals-aa -tbaa -cfl-anders-aa -cfl-steens-aa -globals-aa -objc-arc-aa -scev-aa"
  alias_analysis="-basicaa"
  ...
  $LLVM_PATH/opt -load $PHOENIX_PATH/build/GEP/GEP.$suffix -GEP $lnk_name -o $prf_name ;
